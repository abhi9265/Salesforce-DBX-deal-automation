...
class AuditRepositoryV2:
    """SQLite persistence for current requests and immutable state transitions."""
    ...
    def _initialize(self) -> None:
        with self._connect() as conn:
            conn.executescript(
                ...
                CREATE INDEX IF NOT EXISTS idx_registration_events_request
    ...
    def record_event(self, event: RegistrationEvent) -> None:
        with self._connect() as conn:
            conn.execute(
    ...
    def record_transition(self, request_id: UUID, opportunity_id: str,
        ...
        self.record_event(RegistrationEvent.now(
